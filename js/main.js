// Operador lógico que retorna com dados salvos, ou string vazia, utilizando localStorage.getItem,
// modificando o valor de `string` com JSON.parse()
...
// addEventListener para receber as funções extras da função criaElemento.
...
// função `criaElemento` para que possua apenas a função que faça sentido ao nome.
